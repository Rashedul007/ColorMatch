...
public class MyGradientView extends View {
    ...
    public interface OnColorChangedListener {
        void onColorChanged(MyGradientView view, int color);
    }
    ...
    private MyGradientView mBrightnessMyGradientView;
    ...
    @SuppressLint("NewApi")
    public MyGradientView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.MyGradientView);
            for (int i = 0, n = typedArray.getIndexCount(); i < n; i++) {
                int index = typedArray.getIndex(i);
                switch (index) {
                    case R.styleable.MyGradientView_radius:
                        setRadius(typedArray.getDimensionPixelSize(index, 0));
                        break;
                    case R.styleable.MyGradientView_pointerDrawable:
                        setPointerDrawable(typedArray.getDrawable(index));
                        break;
                    case R.styleable.MyGradientView_lockPointerInBounds:
    ...
    protected void dispatchColorChanged(int color) {
        if (mBrightnessMyGradientView != null) {
            mBrightnessMyGradientView.setColor(color, false);
        }
     ...
     */
    public void setBrightnessGradientView(MyGradientView brightnessGradient) {
        if (mBrightnessMyGradientView != brightnessGradient) {
            mBrightnessMyGradientView = brightnessGradient;

            if (mBrightnessMyGradientView != null) {
                mBrightnessMyGradientView.setIsBrightnessGradient(true);
                mBrightnessMyGradientView.setColor(mSelectedColor);
            }
        }
    }
