...
package com.usefullittleappproduction.palettestudio.Fragment;
...
import com.usefullittleappproduction.palettestudio.Helpers.AutoFitTextureView;
import com.usefullittleappproduction.palettestudio.Helpers.MyImageHelper;
import com.usefullittleappproduction.palettestudio.Helpers.ZoomableImageView;
...
public class Camera2Fragment extends Fragment implements View.OnClickListener, ActivityCompat.OnRequestPermissionsResultCallback
{
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
           // mBackgroundHandler.post(new ImageSaver(reader.acquireNextImage(), mFile));
            mBackgroundHandler.post(new ImageSaver(reader.acquireNextImage(), outputImageFile));
        }
                ...
                switch (displayRotation) {
                    ...
                    case Surface.ROTATION_180:
                        if (mSensorOrientation == 90 || mSensorOrientation == 270) {
                           ...
                           // Toast.makeText(getActivity(), "swapped & sensorOr: " + mSensorOrientation , Toast.LENGTH_SHORT).show();
    ...
    private void openCamera(int width, int height)
    {
        ...
        setUpCameraOutputs(width, height); // sets the preview size
        configureTransform(width, height); //rotates the roatation problem
        Activity activity = getActivity();
        CameraManager manager = (CameraManager) activity.getSystemService(Context.CAMERA_SERVICE);
        try {
    ...
    private void takePicture() {
        ...
        outputImageFile = MyImageHelper.func_makeFolderForImage(getActivity(), "ColorappImgs", "colorappImg_", img_Time_Name, ".jpg");
        strImgPath = outputImageFile.getAbsolutePath();
        outputImgUri = MyImageHelper.getImageFileUriByOsVersion(getActivity(), outputImageFile);
            ...
            CameraCaptureSession.CaptureCallback CaptureCallback
                ...
                public void onCaptureCompleted(@NonNull CameraCaptureSession session,
                  ...
                  //  showToast("Saved: " + outputImageFile);
                    ...
                    //region... to return to calling activity
