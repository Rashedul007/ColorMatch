...
public class Camera2BasicFragment_old extends Fragment   implements View.OnClickListener, ActivityCompat.OnRequestPermissionsResultCallback
{
    ...
    public static Camera2BasicFragment_old newInstance() {
        return new Camera2BasicFragment_old();
    }
    ...
    /**
     * Opens the camera specified by {@link Camera2BasicFragment_old#mCameraId}.
     */
