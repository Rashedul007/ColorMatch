...
//region declare db & table names
    // Database Name
    private static final String DATABASE_NAME = "DbColorMatch";
...
//endregion
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + CREATE_TABLE_MAIN);
        db.execSQL("DROP TABLE IF EXISTS " + CREATE_TABLE_COLOR);
